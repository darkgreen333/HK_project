...
import com.lee.ccc.util.MessageUtils;


public class LoginFailureHandler implements AuthenticationFailureHandler{
	
	@Autowired
	private MemberCommand memCo;
    ...
    protected void loginFailureCount(String username) {
		memCo.countFailure(username);
		/*int cnt = memCo.checkFailureCount(username);
		if(cnt==3) {
			memCo.disabledUsername(username);
		}*/
	}
